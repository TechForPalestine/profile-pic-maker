...
export default function Home() {
  ...
  const handleBgImageSwitch = () => {
    if (backgroundImageUrl === "/bg.webp") {
      setBackgroundImageUrl("/bg-watermelon-v1.webp");
    } else {
      setBackgroundImageUrl("/bg.webp");
    }
  };
        ...
        <div>
          {userImageUrl ? (
            ...
            <>
              ...
              <button
                onClick={handleBgImageSwitch}
                className="rounded-full my-2 py-3 px-2 w-full border border-gray-900 text-xl"
              >
                Use {backgroundImageUrl === "/bg.webp" ? `🍉` : `🇵🇸`} As
                BackGround Instead!
              </button>
