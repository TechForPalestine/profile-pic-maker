    ...
    <main className='text-center px-8 py-12 max-w-lg mx-auto flex justify-center align-center items-center min-h-screen'>
      <div>
        ...
        <div className='pt-8'>
          ...
          <p className='text-gray-600'>For any bugs, please report them to our GitHub repository.<a href='https://github.com/TechForPalestine/palestine-pfp-maker/issues' target='_blank' className='underline cursor-pointer'> GitHub repository</a></p>
        </div>
      </div>
    </main>
  )
