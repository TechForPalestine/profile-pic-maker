...
export const metadata: Metadata = {
  ...
  description:
    'Put a Palestine flag frame around your profile picture in under a minute. Free, no account, and your photo is framed inside your browser — it is never uploaded.',
  ...
  return (
    ...
    >
      <p>
        ...
        white and green — that sits around the edge of the photo you already
        use. You keep your face; the flag goes around it. It was drawn to stay
        readable at the size profile pictures are actually seen at, roughly the
        width of a thumbnail in a timeline.
      </p>
      <p>
        Making one takes three steps. Open the maker, give it a photo — upload
        one from your device, or pull in the picture you already use on X,
        GitHub, GitLab or Bluesky — and download the result. There is no
      ...
      <p>
        ...
        everywhere. Changing your mind later is easy too — your original photo
        is untouched, so you can simply set it back.
      </p>
    </LandingShell>
  );
}
