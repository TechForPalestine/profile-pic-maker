...
/**
 * The profile picture maker itself: pick a photo, preview it inside the flag
 * ring, download it, share it. Everything here runs in the browser.
 *
 * Lives in its own component so the routes that render it (currently the
 * homepage) can stay server components and export their own metadata and
 * structured data.
 */
            ...
            <label className="flex items-start gap-3 mb-3 p-3 text-left text-sm border rounded-lg cursor-pointer select-none">
              ...
              <span>
                ...
                <span className="block text-gray-600">
                  So everyone who sees your picture knows where to make theirs.
                </span>
              </span>
            </label>
            <button
