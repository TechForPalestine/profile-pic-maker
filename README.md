...
4. Optionally keep "Add ppm.t4p.al to the frame" ticked to curve the short URL along the bottom of the border, so anyone who sees your picture knows where to make theirs. Untick it for a plain border.
